...
public class JavaStringBuffer {
    ...
    public static void main(String[] args) {
        //1.string buffer with empty string
        StringBuffer sb_1 = new StringBuffer();
        //2.string buffer with string
        StringBuffer sb_2 = new StringBuffer("Hai..");
        //3.string buffer with string length
        StringBuffer sb_3 = new StringBuffer(20);
